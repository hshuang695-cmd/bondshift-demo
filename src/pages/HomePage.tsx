        ...
        <div className="card overflow-hidden">
          <div className="h-36 gradient-brand relative flex items-end p-5">
            ...
            <div className="relative z-10 flex items-end gap-4 w-full">
              <div className="w-20 h-20 rounded-2xl bg-white/25 backdrop-blur flex items-center justify-center border-2 border-white/40 flex-shrink-0 overflow-hidden">
          ...
          <div className="p-5 space-y-4">
                        ...
                        <div className="flex-1 h-1 bg-surface-200 rounded-full overflow-hidden">
                          <div
                            ...
                            style={{
                              width: `${val}%`,
                              background: val > 50
                                ? 'linear-gradient(90deg, #4f5fcf, #7d95e3)'
                                : 'linear-gradient(90deg, #e8547c, #f490b0)',
                            }}
                          />
                        </div>
            ...
            <div className="flex flex-wrap gap-1.5">
              {bf.tags.map((tag) => (
                <span
                  key={tag.key}
                  className="text-[10px] px-2.5 py-1 bg-brand-50 text-brand-500 rounded-full font-medium"
                >
                  {tag.emoji} {tag.label}
                </span>
              ))}
